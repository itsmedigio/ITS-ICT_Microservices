...
**To enable port forwarding for Kibana, use kubectl port-forward svc/kibana --address 0.0.0.0 5601:5601 and go to** [localhost:5601](localhost:5601 "localhost:5601")
